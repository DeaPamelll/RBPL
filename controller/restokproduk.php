...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Ambil stok lama
    $queryGet = "SELECT Jumlah_Stok FROM barang WHERE ID_Barang = ?";
    ...
    $queryUpdate = "UPDATE barang SET Jumlah_Stok = ?, Deskripsi = ?, Status_Stok = ? WHERE ID_Barang = ?";
    ...
    if ($stmtUpdate->execute()) {
        ...
        header("Location: ../admin-konfirmrestok.php?id=$id_barang&tipe=produk&pesan=sukses");
        exit;
    } else {
