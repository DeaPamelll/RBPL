...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO barang (Nama_barang, Kategori_barang, Jumlah_Stok, Status_Stok, foto_barang, tipe_mime, deskripsi)
              VALUES ('$nama', '$kategori', $jumlah, '$status', '$foto_data', '$mime_type', '$deskripsi')";

    if ($koneksi->query($query)) {
        header("Location: ../admin-konfirmtambahproduk.php?pesan=sukses");
        exit;
    } else {
