...
<body>
    ...
    <div class="product-page">
      <div class="product-image-wrapper">
        <div class="product-image">
          <img src="controller/showimagemenu.php?id=<?= $data['ID_menu'] ?>" alt="<?= htmlspecialchars($data['Nama_menu']) ?>">
        </div>
      </div>

      <div class="product-info">
        <div class="category"><?= htmlspecialchars(strtoupper($data['Kategori_menu'])) ?></div>
        <div class="product-title"><?= htmlspecialchars($data['Nama_menu']) ?></div>
  ...
  <div class="overlay" id="restockOverlay">
    <div class="restock-form">
      ...
      <hr>
      <form action="controller/restokmenu.php" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nama" value="<?= htmlspecialchars($data['Nama_menu']) ?>" class="form-control custom-input" readonly>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="kategori" value="<?= htmlspecialchars($data['Kategori_menu']) ?>" class="form-control custom-input" readonly>
        </div>
        <div class="mb-3">
